...
<div class="container">
	...
	<div class="container">
    <form class="form-horizontal  myform" role="form" method="POST" action="controller">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-user"></i></div>
                        <input type="text" name="middle_name" class="form-control" id="name"
                               autofocus>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="email" class="form-control" id="email"
                               placeholder="your@example.com" required autofocus>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
